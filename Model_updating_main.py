...
N0 = 8000  # Number of training samples
Nv0 = 2000  # Number of validation samples
...
prior_rnd = lambda n_samples: LHS(bounds=range_theta, n_samples=n_samples)
...
### Training of VAE
net = VAE(z_dim, channel, nstep, device).to(device)
